...
function AlertsPage() {
  ...
  const { data: recommendations, isLoading: isLoadingRecommendations, refetch: refetchRecommendations } =
    useAlertRecommendations();
    ...
    try {
      await createRuleFromValidation.mutateAsync({
        alert_rule: {
          ...
          alert_type: recommendation.category,
        },
        sql_query: '', // This will be generated by the validation
