 ...
 */
export function useUserLocation(watch: boolean = false, sendToBackend: boolean = true): LocationState & {
  ...
  const sendLocationToBackend = useCallback(async (loc: UserLocation) => {
