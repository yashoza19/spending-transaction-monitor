...
from src.schemas.alert import AlertType, NotificationMethod, NotificationStatus
...
class TestAlertNotifications(TestUserSetup):
    ...
    def test_get_notification_by_id(self):
        ...
        create_response = client.post("/alerts/notifications", json=notification_payload)
    ...
    def test_update_notification(self):
        ...
        response = client.put(f"/alerts/notifications/{notification_id}", json=update_payload)
        assert response.status_code == 200
