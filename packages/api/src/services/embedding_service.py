...
class SentenceTransformerEmbeddingProvider(EmbeddingProvider):
    ...
    async def get_embedding(self, text: str) -> List[float]:
        ...
        try:
            ...
            logger.info(f"Generated {len(embedding_list)}-dim embedding locally (sentence-transformers)")
...
def get_embedding_client() -> EmbeddingProvider:
    ...
    if provider == 'local' or provider == 'sentence-transformers':
        ...
        logger.warning("Ollama provider is deprecated. Consider using 'local' provider instead.")
        ...
        logger.warning(f"Unknown embedding provider: {provider}, defaulting to local sentence-transformers")
        return SentenceTransformerEmbeddingProvider()
